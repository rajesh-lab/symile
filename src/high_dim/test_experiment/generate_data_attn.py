...
def generate_data(args, n, data_ref):
    ...
    words_df = data_df.apply(lambda r: _generate_text(r, args.data_type), axis=1, result_type='expand')
    words_df.columns = ['word_1', 'word_2', 'word_3', 'word_4', 'word_5']

    data_df = pd.concat([data_df, words_df], axis=1)
