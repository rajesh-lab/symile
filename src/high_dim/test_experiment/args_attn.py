...
def parse_args_save_representations():
    ...
    parser.add_argument("--data_dir", type=Path,
                        default=Path("/gpfs/scratch/as16583/symile/src/high_dim/data/t2_50k/disjoint"),
...
def parse_args_main():
    ...
    parser.add_argument("--concat", type=str_to_bool, default=True,
                        help="Whether to concat text and language embeddings. \
                              Alternative is elementwise product. If latter, then \
                              lang_embed_d must be equal to d.")
