"""
- saves text tokens (because text encoder will be finetuned)
- saves audio representations (because audio encoder will not be finetuned)
- saves image representations (because image encoder will not be finetuned)
"""
import json
import os
...
class HighDimDataset(Dataset):
    def __init__(self, df, txt_tokenizer, img_processor, aud_feat_extractor, max_token_len):
        self.df = df
