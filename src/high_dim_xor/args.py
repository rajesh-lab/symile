...
def parse_args_generate_data():
    ...
    parser.add_argument("--support_train_size", type=float, default=0.8,
                        help="Should be between 0.0 and 1.0. Represents the \
                              proportion of support data to include in train split.")
    parser.add_argument("--support_val_size", type=float, default=0.1,
                        help="Should be between 0.0 and 1.0. Represents the \
                              proportion of support train data to include in val split.")
